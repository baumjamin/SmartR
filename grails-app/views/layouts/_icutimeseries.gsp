<script type="text/ng-template" id="icutimeseries">

<div ng-controller="ICUTimeseriesController">
    ...
    <tab-container>
        ...
        <workflow-tab tab-name="Run Analysis" disabled="runAnalysis.disabled">  
            ...
            <br/>
            <br/>
            <icutimeseries data="runAnalysis.scriptResults" width="1000" height="500"></icutimeseries>
        </workflow-tab>
